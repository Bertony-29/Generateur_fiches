...
def detection_erreur(textFichier: str) -> list: # J'ai remplacé nomFichier par textFichier
    try:
        dossier = "mesFiches"
    ...
    consigne = f"""Tu es un assistant spécialisé dans l'apprentissage de la programmation informatique.
                    ...
                    Réponds uniquement au format JSON, pas en format liste, et avec les clés suivantes : titre, synthese, dangers (liste), symptomes (liste), lien_doc.
